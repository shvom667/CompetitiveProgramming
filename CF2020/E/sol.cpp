...
auto solve(ll n, vector<ll> a, vector<ll> p) {
    vector<Mint> dp(1024, 0), pdp(1024, 0);
...
auto bf(ll n, vector<ll> a, vector<ll> p) {
    Mint res = 0;
