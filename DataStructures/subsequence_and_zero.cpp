 ...
 * Find the number of subsequences such that and of all the elements is 0.
 * n <= 1e6
 * A[i] <= 2^20;
 * Solved by SOS (Sum Over Supersets) DP.
 */
...
void solve() {
  vector<ll> res = {1, 2, 0, 0};
  cout << subsequence_and_zero(res) << "\n";
}
